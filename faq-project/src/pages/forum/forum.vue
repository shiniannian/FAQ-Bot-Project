		        ...
		        <view class="sort-content-item">
		            <view class="sort-content-top" >
		                ...
		                <view class="user-info">
		                    <view class="user-photo">
		                        <image src="../../static/icon/anonymous.png" mode="widthFix"></image>
		                    </view>
		            ...
		            <view class="sort-content-middle">
		                ...
		                <view class="acticle-image">
		                    <block v-for="(item,index) in testImage" :key="index">
		            ...
		            <view class="sort-content-bottom">
		                <view class="like">
		                    <image src="../../static/icon/like.png" class="bottom-img"></image>
		                    <text class="num">99</text>
		                </view>
		                <view class="comment">
		                    <image src="../../static/icon/comment.png" class="bottom-img"></image>
		                    <text class="num">99</text>
		                </view>
...
<script>
	export default {
		data() {
			return {
				testImage:[
				  '../../static/icon/news-detail1.jpg',
				  '../../static/icon/news-detail2.jpg',
				  '../../static/icon/news-detail3.jpg',
				  '../../static/icon/news-detail4.jpg',
				  '../../static/icon/news-detail5.jpg',
				  '../../static/icon/news-detail6.jpg'
				]
			}
		},
		methods: {
